          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                Code Kadai specializes in developing custom software solutions, including SaaS products, web applications, and mobile apps, tailored to meet our clients' needs.
                </p>
