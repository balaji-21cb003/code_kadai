      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Seamlessly Connect Your Tools for Effortless Data Management.`,
              description: `Connect your favorite tools and platforms to create a unified ecosystem that simplifies your workflow. Stay updated in real-time, no matter where you are.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
